    ...
    return (
        <Container className="mt-5">
            ...
            <Form as={Row} className="mt-5">
                <Col xs={12} sm={12} md={12} lg={12} xl={3}  xxl={3} className="d-flex align-items-center mb-1">
                    {activeTab == 0 ? 
                ...
                <Col xs={12} sm={12} md={12} lg={12} xl={4}  xxl={4} className="d-flex align-items-center justify-content-center mb-5 ps-0 pe-0">
